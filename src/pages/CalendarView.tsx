...
export default function CalendarView() {
  ...
  const allEvents = [...events.filter((e) => !e.recurring), ...recurringEvents];
    ...
    >
      ...
      <div className="section-header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {(Object.entries(EVENT_CATEGORY_COLORS) as [
            EventCategory,
            string
          ][]).map(([cat, color]) => (
            <span
        ...
        {days.map((day) => {
          ...
          return (
            ...
            >
              ...
              {dayEvents.length > 4 && (
                <div
                  style={{ fontSize: 10, color: "var(--text3)", paddingLeft: 4 }}
                >
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      recurring: e.target.value as "" | "monthly",
                    })
                  }
                >
            ...
            <div className="modal-header">
              ...
              >
                <span
                  className="dot"
                  style={{
                    background: EVENT_CATEGORY_COLORS[selectedEvent.category],
                  }}
                />
              ...
              >
                ...
                <div>
                  ...
                  <span
                    ...
                    style={{
                      background:
                        EVENT_CATEGORY_COLORS[selectedEvent.category] + "22",
